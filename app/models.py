...
class User(UserMixin, db.Model):
    ...
    Args:
        UserMixin (class): UserMixin Class to inherit from.
        db.Model (object): Database table model to inherit from.

    Returns:
        User (object): User object to be inserted into a database.
    """
...
class Post(db.Model):
    ...
    Returns:
        User (object): Post object to be inserted into a database.
    """
    id = db.Column(db.Integer, primary_key=True)
